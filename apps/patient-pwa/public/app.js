...
state.tab = (['home', 'photos', 'plan', 'timeline', 'messages'].includes(initial) ? initial : 'home');
...
if ('serviceWorker' in navigator)
    navigator.serviceWorker.register('/patient/service-worker.js').catch(console.error);
render();
